...
public class ImageViewEx extends ImageView{
    ...
    {  
        ...
        {  
            ...
            case SCALING:  
                ...
                {  
                    isFinish = true;  
                    if (ImageViewEx.this.mOnViewClickListener != null && !isClicked)  
                    {  
                        isClicked = true;  
                        ImageViewEx.this.mOnViewClickListener.onViewClick(ImageViewEx.this);  
                    } else  
                    {  
                        isClicked = false;  
                    }  
    ...
    {  
        void onViewClick(ImageViewEx view);  
    }  
}
