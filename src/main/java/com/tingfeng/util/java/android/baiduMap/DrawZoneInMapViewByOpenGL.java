...
public class DrawZoneInMapViewByOpenGL implements OnMapDrawFrameCallback{

	private static final String LTAG =DrawZoneInMapViewByOpenGL.class.getSimpleName();
	...
	public DrawZoneInMapViewByOpenGL(MapView mMapView) {
	...
	/**
	 * 在mMapView.onResume();后调用此方法;
	 */
	public void setTextureDisable(){
		textureId = -1;
	}
